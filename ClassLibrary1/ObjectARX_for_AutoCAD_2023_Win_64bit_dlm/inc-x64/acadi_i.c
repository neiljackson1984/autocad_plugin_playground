...
MIDL_DEFINE_GUID(CLSID, CLSID_AcadApplicationMinorVersion1,0xAA46BA8A,0x9825,0x40FD,0x84,0x93,0x0B,0xA3,0xC4,0xD5,0xCE,0xB5);


MIDL_DEFINE_GUID(CLSID, CLSID_AcadApplicationMinorVersion2,0x169B5B8E,0xE315,0x41C7,0x95,0x74,0x66,0xFC,0x7E,0x53,0x0D,0x10);
