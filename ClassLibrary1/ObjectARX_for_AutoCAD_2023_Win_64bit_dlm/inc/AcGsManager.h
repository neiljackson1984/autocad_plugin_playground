...
public:
    ...
    /// <remarks>
    /// This function only works with the legacy graphics kernel.
    /// </remarks>
    [[deprecated("Use AcGsManager2::setGsModel(AcGsGraphicsKernel* pKernel, const AcDbDatabase* pDb, AcGsModel* pModel)")]]
    ...
    /// This function only works with the legacy graphics kernel.
    /// </remarks>
    [[deprecated("Use AcGsManager2::gsModel(AcGsGraphicsKernel* pKernel, const AcDbDatabase* pDb)")]]
    ...
    /// This function only works with the legacy graphics kernel.
    /// </remarks>
    [[deprecated("Use AcGsManager2::setGsHighlightModel(AcGsGraphicsKernel* pKernel, const AcDbDatabase* pDb, AcGsModel* pModel)")]]
    ...
    /// This function only works with the legacy graphics kernel.
    /// </remarks>
    [[deprecated("Use AcGsManager2::gsHighlightModel(AcGsGraphicsKernel* pKernel, const AcDbDatabase* pDb)")]]
    ...
    /// This function only works with the legacy graphics kernel.
    /// </remarks>
    [[deprecated("Use AcGsManager2::hasGsModel(AcGsGraphicsKernel* pKernel, const AcDbDatabase* pDb)")]]
...
public:
    ...
    /// </returns>
    /// <remarks>
    /// This is a convenience method to test for non-null return value from AcGsManager2::gsModel().
    /// </remarks>
