...
void progress1 (int percent_completed) {
    // ASM runs threaded, and this callback function gets called from a worker thread.
    // It is not possible to call aced functions such as acedSetStatusBarProgressMeterPos()
