...
#define DRAWBRIDGE_DATA_API __declspec(dllimport)
    ...
    static DRAWBRIDGE_DATA_API const AcUniqueString *k2DDrawing;    // "2D Drawing"
    static DRAWBRIDGE_DATA_API const AcUniqueString *k3DDrawing;    // "3D Drawing"
    static DRAWBRIDGE_DATA_API const AcUniqueString* k3DDrawing2;    // "3D Drawing2"
    static DRAWBRIDGE_DATA_API const AcUniqueString *k3DSelection;  // "3D Selection"
    static DRAWBRIDGE_DATA_API const AcUniqueString *k3DRapidRTRendering;  // "RapidRT Rendering"
